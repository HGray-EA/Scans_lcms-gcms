...
# Function which reads tsv
  readtsv <- function(filepath){
    ...
    read.table(paste0("C:/Users/hg000051/Downloads/",filepath), sep = '\t', header =T)
  }
...
# LC/GC-MS library
  LCGC_Lib <- readxl::read_excel("C:/Users/hg000051/Downloads/Combined GCMS  LCMS Database MAY 2025.xlsx", skip=2) %>% 
...
#Load RSN sites
  RSN_Sites <- readxl::read_excel("C:/Users/hg000051/Downloads/RSN_Site_Locations_PBI_Download.xlsx")
```
...
The below plot shows the seasonal variation in the log of the concentration through the seasons- summer and autumn have a median concentration higher than winter and spring. There is a temporal variation in concentration. 
...
We also have heterscadacity on our model which shows it's baised independence?
